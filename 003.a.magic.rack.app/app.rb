...
TWITTER = Twitter::REST::Client.new do |config|
  ...
  config.consumer_key = "hAPxFvf3m9LiT0vrVxwAGrzem"
  config.consumer_secret = "X92ZE3dYIw4SrcHaeH84r857XGgHTTf9UunnItH5xXRrsRHgNm"
  config.access_token = "3374296679-LJ0WuIltciosSFcOoe6Om6cvIwV3BVELlh5Qf01"
  config.access_token_secret = "wf1NmOhH5ZvNHL9iHnkqbGrNjsfuHv5cXxcGz6MpxzSIT"
end
