...
TWITTER = Twitter::REST::Client.new do |config|
  ...
  config.consumer_key = "dhfliyr8q475o3q4rhlkafhqo847"
  config.consumer_secret = "fayr843545ky847yajsdbfajlsdfgoueyrtel"
  config.access_token = "43576-nfasjdflafamabfsbdmabdfj"
  config.access_token_secret = "intothemainframeiamhacking3453874y"
end
